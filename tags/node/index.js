...
<head>
    ...
    <meta content="I help companies develop software products and make technical decisions. - " property="og:description">
    <meta name="author" content="gaboesquivel.com">

    <title>Gabo Esquivel - Software Engineer and Consultant</title>

    
    <link href="/tags/node.js/index.xml" rel="alternate" type="application/rss+xml" title="Gabo Esquivel - Software Engineer and Consultant" />
    <link href="/tags/node.js/index.xml" rel="feed" type="application/rss+xml" title="Gabo Esquivel - Software Engineer and Consultant" />
      ...
      <div class="row">
        <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
               ...
               <div class="post-preview">
                 <a href="/blog/2014/node.js-https-and-ssl-certificate-for-development/">
                      <h2 class="post-title">Node.js HTTPS and SSL Certificate for Development</h2>
                      <p class="post-subtitle">HTTPS is the HTTP protocol over TLS/SSL and HTTPS is required to protect your data. It is the most popular network protocol for establishiing secure connections for exchanging documents on the internet. It is basically HTTP carried over a TCP socket, which has been secured using SSL. Transport Layer Security (TLS) and Secure Sockets Layer (SSL) are cryptographic protocols designed to provide communication security. In this post I&#39;ll show how to create a self-signed SSL certificate and set up an express 4.0 project that uses it for local development purposes.</p>
                    </a>
