  ...
  return (
    <section>
      ...
      <p className="prose prose-neutral dark:prose-invert"> 
        I'm a full-stack software engineer focused on building innovative products with a great user experience. My expertise spans nodejs, react, react native, typescript, smart contracts and foundational knowledge in rust, go and python, complemented by ongoing AI explorations. My approach is rooted in agile methodologies, striving for precision in technology implementation.
      </p>
