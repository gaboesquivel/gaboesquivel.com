...
- To avoid some inconvenient interface - for instance to avoid making actual requests to a [server](/backend) from tests.   
...
- [Mocks Aren't Stubs](http://martinfowler.com/articles/mocksArentStubs.[html](/frontend)) by Martin Fowler   
- [XUnit Test Patterns: Test Double Patterns](http://xunitpatterns.com/Test%20Double%20Patterns.[html](/frontend))   
