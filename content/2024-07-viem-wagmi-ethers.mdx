...
- **[EVM](/tech/ethereum) Data Indexer**: Viem is used with [Node.js](/tech/nodejs) to efficiently index data from the [Ethereum](/tech/ethereum) Virtual Machine (EVM) in backend systems.
