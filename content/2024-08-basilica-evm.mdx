---
title: Introducing BasilicaEVM
publishedAt: 2024-08-15
summary: FullStack EVM Project Starter with 0x and Codex integration
image: /images/2024/08/basilica-evm.webp
---

In the rapidly evolving landscape of blockchain development, the tools you choose can make or break your project. That's why I'm excited to introduce BasilicaEVM. A comprehensive development stack designed to streamline the creation of EVM based applications. Whether you're building DeFi platforms, NFT marketplaces, or any decentralized application, BasilicaEVM equips you with the best tools and practices to get the job done efficiently and effectively.


{/* Prevent CLS by setting a minimum height */}
<div style={{ minHeight: '300px' }}>
![BasilicaEVM](/images/2024/08/basilica-evm.webp)
</div>


## A Closer Look at BasilicaEVM

### Revolutionizing User Experience with Gasless Swaps

One of the standout features of BasilicaEVM is its support for gasless swaps, powered by the 0x API v2 and the Tx Relay API. This integration eliminates the friction and complexities associated with gas fees, which are often a significant barrier for users in decentralized exchanges (DEXs). By removing gas-related hurdles, BasilicaEVM:
...
BasilicaEVM integrates Codex.io, a powerful tool for managing and analyzing blockchain data, used by industry leaders like TradingView, Matcha.xyz, and Sudoswap. Codex provides:

- Real-time access to pricing, volume, liquidity, and wallet data across 60+ networks, including Ethereum, Solana, and Arbitrum.
...
BasilicaEVM is built on a modern stack that ensures your applications are not only scalable but also performant and secure. Here’s what’s under the hood:

- **Turbo Monorepo and Bun**: Efficient management of large-scale codebases and ultra-fast build processes.
- **Biome and Next.js 14**: Modern tooling for web projects, ensuring quick iterations, robust server-side rendering, and improved SEO.
...
- **RainbowKit**: Out-of-the-box wallet connection library, offering a polished and customizable UI for connecting to various wallets.

This stack is designed for speed and scalability, supporting everything from rapid prototyping to high-concurrency operations. With clear conventions and AI-assisted development tools like cursor.so and v0.dev, BasilicaEVM ensures that your team can maintain high code quality while moving fast.

### Building the Future Together

BasilicaEVM is on its early stages with a minimal set of features. I invite you to explore the [BasilicaEVM GitHub repository](https://github.com/blockmatic/basilica-evm) and contribute to its growth. Whether you're adding new features, improving documentation, or simply experimenting, your contributions are invaluable.
