...
by default in the starter template. For the latest features and integrations, please visit the [BasilicEVM GitHub repository](https://github.com/blockmatic/basilic-[evm](/tech/evm))._
...
- **EVM Integration**: Seamless blockchain functionality through viem and wagmi, providing [type-safe interactions](/backend) and React hooks.
