...
tech: ['NodeJS', 'TypeScript', 'JavaScript', 'AI SDK', 'OpenAI']
---
...
[NodeJS](/tech/nodejs) is becoming an increasingly useful option for building RAG systems, especially for teams already working within the [JavaScript](/tech/javascript)/[TypeScript](/tech/typescript) ecosystem. Embedding APIs and integration options are solid enough that you can:
...
I've applied RAG architectures in real-world projects like [Legal Agent](/project/legal-agent), a legal AI assistant trained on court decisions and legal doctrine, and [Bitlauncher](/project/bitlauncher), a [decentralized launchpad](/backend) that integrates AI for project evaluation and discovery.

While Python remains the ecosystem leader for AI tooling, the JavaScript/TypeScript stack is catching up fast—offering a familiar environment for [web engineers](/frontend) who want to ship [AI](/ai) products.
