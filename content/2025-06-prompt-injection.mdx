...
category: ['Engineering', 'Backend', 'Frontend', 'Artificial Intelligence', 'Security']
tech: ['AI SDK', 'OpenAI']
---
...
Leverage an LLM to evaluate incoming content for signs of prompt injection or [adversarial manipulation](/backend).
...
Post-process outputs using regex, classifiers, or moderation APIs to catch unexpected or harmful content before it reaches the [user](/frontend).
