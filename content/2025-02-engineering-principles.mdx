...
tech: ['JavaScript', 'TypeScript', 'EVM']
---

Engineering principles serve as the foundation for building robust, maintainable, and scalable [software systems](/fullstack). They guide technical decisions, shape development practices, and ultimately determine the long-term success of software projects. In this post, I'll share key engineering principles that I've found invaluable throughout my career building [web applications](/frontend) and [blockchain systems](/web3). These principles are technology-agnostic and focus on delivering value while maintaining high standards of quality and reliability.
...
Engineering is not just about writing code—it's about crafting [systems that stand the test of time](/tech). These principles guide decision-making, ensuring that software remains maintainable, scalable, and valuable to users.
