...
ERC-20, ERC-721, ERC-1155, and their extensions form the language of value transfer on-chain. They ensure your token can move seamlessly across wallets, DEXs, lending protocols, and DAOs. Without this [baseline](/fullstack), nothing else would fit together.
...
### Liquidity [Infrastructure](/backend)
...
DAO [infrastructure](/backend) has matured into its own stack:
