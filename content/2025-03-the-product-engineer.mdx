...
- Solid understanding of modern [frontend frameworks](/tech) (React, [Next.js](/tech/next-j[js](/tech/javascript))
- Experience with backend systems and API design ([Node.js](/tech/node-js), edge functions, [serverless](/tech/serverless))
