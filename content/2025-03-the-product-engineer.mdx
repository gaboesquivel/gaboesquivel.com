...
summary: What I look for in a product engineer—ownership across product, interface, and systems, not a title swap for frontend or backend.
image: /images/2025/03/product-engineer.webp
category: ['Product', 'Engineering', 'Tech Lead', 'Startups', 'Institutions', 'Fullstack']
tech: ['JavaScript', 'TypeScript', 'Ethereum', 'AI SDK']
---
...
- Solid understanding of modern frontend frameworks ([React](/tech/reactjs), [Next.js](/tech/nextjs))
