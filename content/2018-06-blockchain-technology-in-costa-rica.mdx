...
category: ['Community', 'Blockchain', 'Web3']
tech: ['Ethereum', 'EOS', 'Antelope', 'Polkadot', 'Substrate']
---

In September 2017, BlockchainCR was founded as a community hub for studying and promoting [blockchain](/web3) technology in [Costa Rica](/blog/2014-01-developing-software-in-costa-rica). The organization aims to make [Costa Rica](/blog/2014-01-developing-software-in-costa-rica) a leading country in the use of [blockchain](/web3), decentralized networks, and distributed ledger technologies.
