...
Wagmi is built on TanStack Query for those same primitives. It ships over 20 hooks for wallets, ENS, contracts, transactions, signing, and more, plus connectors for injected providers, [WalletConnect](/tech/wagmi), MetaMask, and Coinbase Wallet. Coinbase, [Stripe](/tech/stripe), Shopify, Uniswap, Optimism, ENS, and Sushi use it in production.
