...
category: ['Community', 'JavaScript', 'Costa Rica']
tech: ['JavaScript', 'NodeJS', 'ReactJS']
---

Last Saturday, April 11, several members of the Costa Rica [JS](/tech/javascript) group gathered, this time we broke the mold a bit and went to Under Fire Paintball territory.
