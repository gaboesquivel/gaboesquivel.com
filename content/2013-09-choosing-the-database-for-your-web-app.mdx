...
summary: A guide to choosing the right database for your web application
category: ['Databases']
tech: ['MongoDB', 'PostgreSQL', 'MySQL']
---

When choosing a [database](/backend) for your application, you need ask yourself many questions and there are important rules about Data Architecture
