...
category: ['Product', 'Artificial Intelligence', 'UX', 'Frontend', 'Fullstack']
tech: ['OpenAI', 'AI SDK']
---
...
Good AI UX is about trust, visibility, and control. You need to know what the agent is doing, why it's doing it, and when you can override it. Without that, proactivity feels like loss of control instead of help.
