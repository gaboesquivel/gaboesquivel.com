...
category: ['Engineering', 'Frontend', 'Fullstack']
...
In this post I will introduce you to Gulp.js, a [JavaScript](/tech/javascript) task runner that helps you automate your development process.
