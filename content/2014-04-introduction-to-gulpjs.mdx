...
summary: Getting started with Gulp.js build system
category: ['JavaScript', 'NodeJS']
tech: ['JavaScript', 'NodeJS', 'Gulp']
---
...
In this post I will introduce you to Gulp.[js](/tech/javascript), a [javascript](/tech/javascript) task runner that helps you automate your development process.
...
- [css](/frontend) preprocessing ( sass, less, …)
- optimization: concatenating and minifying [css](/frontend) and scripts, compressing new or modified images, ...
- deploying updates to a staging or production [server](/backend)
...
- Really simple and elegant [API](/backend)    
