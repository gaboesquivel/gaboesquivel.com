...
summary: How USDT0 and LayerZero's OFT standard move USDT across chains without wrapping, with unified liquidity and a smaller bridge attack surface
image: /images/2025/03/usdt0.webp
category: ['Web3', 'DeFi', 'Backend']
tech: ['Ethereum']
---

Stablecoins like USDT (Tether) have become essential in [DeFi](/web3) for moving value across blockchains. Cross-chain movement is still the hard part. Traditional bridges introduce security risks, fragmented liquidity, and a poor user experience.  
...
Personally, I'm looking forward to seeing USDT0's adoption grow as the industry moves toward safer cross-chain paths. Stablecoins that move across chains without the usual bridge failure modes would be a real step for [DeFi](/web3), and it will still take work from the teams that operate those systems.