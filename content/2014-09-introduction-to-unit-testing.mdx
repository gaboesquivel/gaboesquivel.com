...
summary: Getting started with unit testing in JavaScript
category: ['Testing']
...
2.  The continuous integration (CI) [server](/backend) must be able to run the entire suite of tests without any manual intervention.

Although through unit tests you can prove the small units work perfectly in isolation, the units of code may blow up when combined and that's why you need Integration Testing, a logical extension of unit testing. In its simplest form, two units that have already been tested are combined into a [component](/frontend) and the interface between them is tested. A component, in this sense, refers to an integrated aggregate of more than one unit.
...
- [Writting Testable Javascript](http://www.adequatelygood.com/Writing-Testable-[JavaScript](/tech/javascript).html) by Ben Cherry
