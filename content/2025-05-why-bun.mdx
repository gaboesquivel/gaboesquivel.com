...
Bun has become my go-to [JavaScript](/tech/javascript) runtime for new [projects](/fullstack)—and it's not just about speed. It's about how much friction it removes from the development process. After years of juggling [Node.js](/tech/node-js), Deno, and various toolchains, Bun feels like the runtime I always wanted.
...
Bun is built with Zig and uses JavaScriptCore (Safari's engine) instead of V8. This [architectural choice](/backend) translates to real-world speed gains:
...
This native support allows for leaner applications and faster development when building chat apps, live feeds, or [multiplayer game backends](/tech).
