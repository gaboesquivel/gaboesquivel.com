...
category: ['Engineering', 'Frontend', 'Backend', 'Fullstack']
tech: ['JavaScript', 'NodeJS']
---

updated on 05/2015.

## [JavaScript](/tech/javascript) Jabber

Simply the best [Javascript](/tech/javascript) podcast out there. 
...
## NodeUp &#8211; [NodeJS](/tech/node-js) Awesomeness

A [node.js](/tech/node-js) podcast put together by @ffloat and @dshaw..
